...
class FileOperation {
    ...
    boolean newFileFlag;
    String fileName;
    String applicationTitle = "MyNotePad";
...
//////////////////////////////////////
}// end definition of class FileOperation
...
public class Notepad implements ActionListener, MenuConstants {
    ...
    String applicationName = "MyNotePad - Sumit";
...
////////////////////////////////////
            ...
            JOptionPane.showMessageDialog(Notepad.this.f, aboutText, "Yeeeyyyy!!!!!", JOptionPane.INFORMATION_MESSAGE);
        } else
...
interface MenuConstants {
    ...
    final String aboutText =
            "<html><big>My NotePad</big><hr>" + "<p align=right>Developer: Sumit Wankhede"
                    + "<br><strong>Thanx 4 using MyNotePad</strong><br><html>";
}
